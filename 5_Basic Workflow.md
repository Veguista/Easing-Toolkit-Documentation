...
It is found inside the **EasingTools** class. To gain access to the **EasingTools** class, users can specify that they are using the **EasingToolkit namespace** at the beginning of their script by adding the following line of code:
> **using EasingToolkit;**
